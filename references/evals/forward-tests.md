...
Use these prompts to test whether AI Project Skill Maker can create useful maintainer guidance without relying on hidden context from its own implementation work.
...
```text
Use ai-project-skill-maker to create a maintainer instruction bundle for a new documentation-heavy developer tool project.
...
```text
Use ai-project-skill-maker to create a maintainer skill for this existing repository.
...
```text
Use ai-project-skill-maker to refresh the existing maintainer skill at ./generated/repo-maintainer after repository changes.
...
```text
Use ai-project-skill-maker to create platform-neutral maintainer guidance for this repository, then render adapter outputs for AGENTS.md, CLAUDE.md, Cursor rules, and GitHub Copilot instructions.
